        ...
        <div className="card-grid">
          ...
          <div className="card">
            ...
            <ul>
              ...
              <li><a href="/docs/get-started/tutorials/collect-payments/" target="_blank" rel="noopener noreferrer">Collect payments on website</a></li>
              <li><a href="/quickstart-guides/integration-tutorials/" target="_blank" rel="noopener noreferrer">Integration tutorials</a></li>
            </ul>
          </div>
          ...
          <div className="card">
            <h3>
              <span className="icon">
                <img src={ai} alt="AI" style={{width: '1.2em', height: '1.2em', verticalAlign: 'middle'}}/>
              </span> 
              AI & Agents
            </h3>
            <ul>
              <li><a href="https://docs.zuora.com/en/zuora-platform/system-management/zuora-ai" target="_blank" rel="noopener noreferrer">Zuora AI overview</a></li>
              <li><a href="https://docs.zuora.com/en/basics/use-of-ai-in-zuora/zuoras-approach-to-ai" target="_blank" rel="noopener noreferrer">Zuora’s approach to AI and the commitments to you</a></li>
              <li><a href="https://docs.zuora.com/en/zuora-platform/system-management/zuora-ai/zuora-mcp-server" target="_blank" rel="noopener noreferrer">Zuora MCP overview</a></li>
              <li><a href="/docs/ai/skills-agents/" target="_blank" rel="noopener noreferrer">Some Skills for your Agents</a></li>
            </ul>
          </div>
