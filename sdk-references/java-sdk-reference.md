...
The latest Java client library version is **3.20.0**.
...
Note that in your code, you should use the `com.zuora.ZuoraClient` package instead of `com.zuora.sdk.ZuoraClient`.
`com.zuora.sdk.ZuoraClient` is a legacy package and is added only for backward compatibility.
...
<td><strong>queryAccountByKey</strong></td>
<td><strong>GET</strong> /object-query/accounts/{key}</td>
<td>Retrieve an account</td>
</tr>
<tr>
<td><em>ObjectQueriesApi</em></td>
<td><strong>queryAccounts</strong></td>
