...
- LLM Internals - what's inside the black box and why does that matter?
- Prompt Best Practices - good prompts aren't easy.
- Our internal AI architecture - so we can ensure the uniformity and centralized management needed for compliance, security and to keep our costs under control.
- UI Toolkit for AI - Our UX team created our 'UI Toolkit for AI', one design language and toolkit to bring our AI based solutions to life. Whether a team is building AI for Assistant, Insight or Agent experiences, we now have one design language.
- Developer Reference Store - a prototype repository to ensure the highest consistency from prompt based features.
- Aman Singla, from <a href="https://www.immersa.ai/" target="_blank">Immersa</a>, discussed effective context management, we need our LLM to reason effectively through tasks, not just retrieve answers.
- Wade Chambers, from <a href="https://amplitude.com/" target="_blank">Amplitude</a>, shared their experiences in shipping AI-based products.
- Best practices based on hard won experiences for fine tuning and testing all our AI-solutions.
- Existing AI-based project review - we already have many in flight AI related projects, so here we stepped back to review what we learned and what we will do better. And we set a goal of 50 such projects by fiscal year end (Zuora's fiscal calendar ends in January).
- Our CISO reminded everyone of <a href="https://docs.zuora.com/en/basics/use-of-ai-in-zuora/zuoras-approach-to-ai" target="_blank">our AI Policy</a> so we know where the guard rails are.

And we saw Windsurf, Claude Cursor, Gemini, Vercel, and Trupeer used in our AI Week 'hands on' practical sessions.
