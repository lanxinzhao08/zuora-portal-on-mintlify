...
Each environment uses a different base URL. Select the appropriate base
URL below that you need to use:
...
|US API Sandbox | https://rest.sandbox.na.zuora.com (Cloud 1) <br /> [https://rest.apisandbox.zuora.com](https://rest.apisandbox.zuora.com) (Cloud 2)|
