...
- <a href="https://docs.zuora.com/en/zuora-platform/system-management/zuora-ai/zuora-mcp-server/configure-zuora-remote-mcp-server/configure-zuora-local-mcp-client/install-zuora-mcp-server-in-claude-code-for-desktop-client" target="_blank">Local MCP server installation guide</a>


While a brief list of <a href="https://docs.zuora.com/en/zuora-platform/system-management/zuora-ai/zuora-mcp-server/tools-reference-for-zuora-mcp" target="_blank">available MCP tools</a> is available, we encourage you to take advantage of the server's built-in AI capabilities. Ask the server about its capabilities (for example, "What can I do with the manage_workflow tool?") or how to use a specific tool or Zuora feature effectively (for example, "Give me five useful prompts for working with invoices.").